...
clim2 <- fdth:::make.fdt.format.classes(
  clim1,
  right,
  pattern
)
...
t61 <- fdt_cat(data.frame(
  c1 = sample(LETTERS[1:3],
    replace = TRUE,
    size = 10
  ),
